...
It keeps the setup light on purpose. You get the contributor forms, PR template, review guidance, and optional PR review workflow, but not release-prep automation yet.
...
3. Add `OPENAI_API_KEY` only if you want the optional Codex pull request review workflow.
